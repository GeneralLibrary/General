...
namespace General.Regions.Behaviors
{
    /// <summary>
    ...
    /// If you use the <see cref="General.Regions.Region.Add(object,string,bool)" /> method with the createRegionManagerScope option, the scoped manager will be attached to the view.
    /// </remarks>
