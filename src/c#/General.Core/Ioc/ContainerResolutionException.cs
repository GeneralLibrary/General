...
namespace General.Ioc
{
    ...
    public class ContainerResolutionException : Exception
    {
        ...
        /// </summary>
        /// <remarks>
        /// Please file an issue with the General team if you encounter a ContainerResolutionException with this message
        /// </remarks>
        public const string UnknownError = "You seem to have hit an edge case. Please file an issue with the General team along with a duplication.";
